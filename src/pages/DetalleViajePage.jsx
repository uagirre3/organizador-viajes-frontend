  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid grid-cols-2 gap-3">
        <Link to={`/viajes/${id}/resumen`} className="rounded-2xl border border-slate-200 p-4 text-center text-sm font-medium text-slate-800 shadow-sm">
          Resumen
        </Link>

        <Link to={`/viajes/${id}/agenda`} className="rounded-2xl border border-slate-200 p-4 text-center text-sm font-medium text-slate-800 shadow-sm">
          Agenda
        </Link>
      </section>
